...
\begin{claim}
	For a random variable $X$, an ordered set $S=\{x_1<\dots<x_m\} \subset \support(X)$, $x_0=-\infty$ and $x_{n+1}=\infty$, there is no random variable $X'$ such that $\support(X')=S$ and $d_k(X,X') < \max\limits_{i=0,..,m} w(x_{i}, x_{i+1})$.
\end{claim}
\begin{proof}
...
\begin{claim}
	For a random variable $X$, an ordered set $S=\{x_1<\dots<x_m\} \subset \support(X)$, $x_0=-\infty$ and $x_{n+1}=\infty$, there is a random variable $X'$ such that $\support(X')=S$ and $d_k(X,X')= \max\limits_{i=0,..,m} w(x_{i}, x_{i+1})$.
\end{claim}
\begin{proof}
