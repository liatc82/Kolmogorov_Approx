...
Let, in the scope of this section, $X$ be a given random variable with a finite support of size $n$, and let  $0<m\leq n$ be a given complexity bound. We will now develop notations and collect facts towards an algorithm for finding an $m$-optimal approximation of $X$.
