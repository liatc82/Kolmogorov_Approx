...
performance in credit scoring. There are three computational methods of KS in terms of score binning: (1) the method with equal-width binning~\cite{mays2001handbook}, (2) the method with equal-size binning~\cite{refaat2011credit}, and (3) the method without binning~\cite{bolton2010logistic,siddiqi2012credit}, this method uses
