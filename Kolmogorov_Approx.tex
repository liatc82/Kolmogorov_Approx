...
%	Deriving the new random variable $X'$ from the computed path $l$ takes $O(mn)$. For every node in $l$ (at most $m$ nodes), calculating the weight $P(-\infty<X<\infty)$ takes at most $n$ steps. 
